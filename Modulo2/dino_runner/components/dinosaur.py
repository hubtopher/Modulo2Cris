...
from dino_runner.utils.constants import DUCKING_HAMMER, HAMMER_TYPE, HEART_TYPE, JUMPING_HAMMER, RUNNING, JUMPING, DUCKING, RUNNING_HAMMER, SHIELD_TYPE, DEFAULT_TYPE, DUCKING_SHIELD, JUMPING_SHIELD, RUNNING_SHIELD
...
class Dinosaur(Sprite):
    ...
    def update (self, user_input):
        ...
        if  user_input[pygame.K_UP] and not self.dino_jump:
            jump_sound= pygame.mixer.Sound('jumpsound.ogg')
            self.dino_jump = True
            self.dino_run = False
            jump_sound.play()
